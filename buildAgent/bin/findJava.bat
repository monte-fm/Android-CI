...
IF NOT "%2" == "REG_SCAN" GOTO java_closure_reg_scan_end
  ...
  FOR %%W IN (\ \WOW6432Node\) DO FOR %%V IN (1.6 1.7) DO CALL "%TEAMCITY_FIND_JAVA%" _CLOSURE_ REG_JDK_2 %%W %%V
  FOR %%W IN (\ \WOW6432Node\) DO FOR %%V IN (1.6 1.7) DO CALL "%TEAMCITY_FIND_JAVA%" _CLOSURE_ REG_JRE_2 %%W %%V
  GOTO end
